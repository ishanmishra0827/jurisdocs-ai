...
SYSTEM_PROMPT = (
    ...
    "  Before choosing this case, read every excerpt provided. Concluding that the "
    "document is silent when the governing provision is actually present is a "
    "serious failure: it denies the reader a remedy the statute gives them, and they "
    "have no way to know you were wrong. Only choose CASE B if no excerpt addresses "
    "the subject at all.\n"
    ...
    "CASE C — The user asks you to recommend a course of action or make a judgment call for them ('should I sue', 'should I fight this', 'what would you do', 'is it worth it').\n"
    "  This case is narrow. Asking what remedies, rights, or options the statute provides is NOT advice-seeking — 'what are my options', 'what can I do', 'is that legal', 'can my landlord do this' are research questions and belong in CASE A. Answer them from the excerpts. Only a request for a recommendation about the reader's own decision falls here.\n"
